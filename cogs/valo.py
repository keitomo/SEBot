...
class ValoCog(commands.Cog,name="Valorant"):
    ...
    @valo.command(description="現在ボイスチャンネルに接続しているメンバーをリストに追加します",guild_ids=guild_list)
    ...
    @valo.command(description="現在リストに追加されているメンバーを表示します",guild_ids=guild_list)
    ...
    @valo.command(description="プレイヤーをリストに追加します",guild_ids=guild_list)
    ...
    @valo.command(description="プレイヤーをリストから削除します",guild_ids=guild_list)
    ...
    @valo.command(description="プレイヤーリストをリセットします",guild_ids=guild_list)
    async def reset(self,ctx):
        valoplayer = ValoCog.GetValoList(self,ctx)
        valoplayer.clear()
        await ctx.respond("プレイヤーリストを削除しました！")

    @valo.command(description="プレイヤーをランダムにチーム分けします",guild_ids=guild_list)
