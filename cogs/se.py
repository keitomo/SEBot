...
class SECog(commands.Cog,name="SE-Bot"):
    ...
    @se.command(name="dc",description="SE-Botが通話から切断します",guild_ids=guild_list)
    ...
    @se.command(name="list",description="登録されているSEを表示します",guild_ids=guild_list)
    ...
    @se.command(name="add_word",description="サーバー辞書に単語を追加します",guild_ids=guild_list)
    ...
    @se.command(name="delete_word",description="サーバー辞書から単語を削除します",guild_ids=guild_list)
    ...
    @se.command(name="list_word",description="サーバー辞書に登録されている単語を表示します",guild_ids=guild_list)
